...
set WarningFlags=-nologo -WX -W4 -wd4201 -wd4189 -wd4505 -wd4238 -wd4100 -wd4026 -wd4244 -wd4996 -wd4127
...
cl %CompilerFlags% ../quiz_sdl.c  /I W:\vq\SDL\include /link /LIBPATH:W:\vq\SDL\lib\x64 SDL2.lib SDL2main.lib SDL2_ttf.lib /SUBSYSTEM:CONSOLE

cl %CompilerFlags% ../quiz_server.c /link ws2_32.lib User32.lib /SUBSYSTEM:CONSOLE
cl %CompilerFlags% ../quiz_client.c /link ws2_32.lib User32.lib /SUBSYSTEM:CONSOLE
